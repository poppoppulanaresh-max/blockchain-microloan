...
function PrivateRoute({ children, roles }) {
  ...
  if (loading) return <div style={{ color: "#4a7090", padding: 40 }}>Loading...</div>;
  ...
  return (
    <Routes>
      ...
      <Route path="/admin" element={
        <PrivateRoute roles={["auditor","government"]}><AdminPanel /></PrivateRoute>
      }/>
      <Route path="/audit" element={
        <PrivateRoute roles={["auditor","government"]}><AuditLogs /></PrivateRoute>
      }/>
